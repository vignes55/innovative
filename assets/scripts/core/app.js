    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            /*if (content.height() < available_height) {
                content.attr('style', 'min-height:' + available_height - 45 + 'px !important');
            }*/
        } else {
            ...
            /*if (height >= content.height()) {
                content.attr('style', 'min-height:' + height - 45 + 'px !important');
            }*/
        }
    }
    ...
    var handleScrollers = function () {
        $('.scroller').each(function () {
            ...
            $(this).slimScroll({
                ...
                railColor: ($(this).attr("data-rail-color")  ? $(this).attr("data-rail-color") : '#000'),
                position: isRTL ? 'left' : 'right',
                height: height,
...
$(document).ready(function () {
    ...
    //alert(WinHeight);    
    $(".left_nav").css("height", WinHeight - 45);
    $(".page-content-wrapper").css("height", WinHeight - 45);
    $(".page-content").css("height", WinHeight - 45);
    $("#RadPane1 iframe").css("height", WinHeight - 48);
    $(".page-sidebar-menu").css("height", WinHeight - 100);
//    $(window).resize(function () {        
//        location.reload();
//    });
...
//alert(sessionStorage.IENVal);

var IE9 = (navigator.userAgent.indexOf("MSIE 9") >= 0) ? true : false;
if (sessionStorage.IENVal == undefined) {
    if (IE9) {
        ...
        $(function () {
            ...
            $("<div class='noti'><div id='notification_close'>X</div><h2 class='whatnow'><b>Sorry!! Your browser (Internet Explorer 9) is out-of-date. <br>Please Use Firefox/Chrome/Internet Explorer 10 and above <br>for comfort &amp; better experience:</b></h2><table class='logos'><tbody><tr><td class='b bf'><a onmousedown='countBrowser('f')' target='_blank' href='http://www.mozilla.com/firefox/' class='l'><span class='bro'>Firefox</span></a></td><td class='b bc'><a onmousedown='countBrowser('c')' target='_blank' href='http://www.google.com/chrome?hl=en' class='l'><span class='bro'>Chrome</span></a></td><td class='b bi'><a onmousedown='countBrowser('i')' target='_blank' href='http://windows.microsoft.com/en-US/internet-explorer/downloads/ie' class='l'><span class='bro'>Internet Explorer</span></a></td></tr></tbody></table><div class='dontshow'><input type='checkbox' name='dont' onclick='IENCheck()' id='dont'><label>Don't show this msg</label></div></div>")
			    .css({
...
function IENCheck() {
    var x = document.getElementById("dont").checked;
    if (x == true) {
        sessionStorage.IENVal = 1;
        $("#notiOuter").hide();
        $(".noti").hide();
    }
}
...
if (IE8) {
    ...
    $(function () {
        ...
        $("<div>")
			...
			$("<div class='noti'><h2 class='whatnow'><b>Sorry!! Your browser (Internet Explorer 8) is out-of-date and may not display all features of this and other Applications. Please download one of these browsers below <br>for comfort &amp; better experience:</b></h2><table class='logos'><tbody><tr><td class='b bf'><a onmousedown='countBrowser('f')' target='_blank' href='http://www.mozilla.com/firefox/' class='l'><span class='bro'>Firefox</span></a></td><td class='b bc'><a onmousedown='countBrowser('c')' target='_blank' href='http://www.google.com/chrome?hl=en' class='l'><span class='bro'>Chrome</span></a></td><td class='b bi'><a onmousedown='countBrowser('i')' target='_blank' href='http://windows.microsoft.com/en-US/internet-explorer/downloads/ie' class='l'><span class='bro'>Internet Explorer</span></a></td></tr></tbody></table></div>")
			.css({
			    backgroundColor: '#bfe5ff',
			    'top': '10%',
			    'left': '20%',
...
if (IE7) {
    ...
    $(function () {
        ...
        $("<div>")
			...
			$("<div class='noti'><h2 class='whatnow'><b>Sorry!! Your browser (Internet Explorer 7) is out-of-date and may not display all features of this and other Applications. Please download one of these browsers below <br>for comfort &amp; better experience:</b></h2><table class='logos'><tbody><tr><td class='b bf'><a onmousedown='countBrowser('f')' target='_blank' href='http://www.mozilla.com/firefox/' class='l'><span class='bro'>Firefox</span></a></td><td class='b bc'><a onmousedown='countBrowser('c')' target='_blank' href='http://www.google.com/chrome?hl=en' class='l'><span class='bro'>Chrome</span></a></td><td class='b bi'><a onmousedown='countBrowser('i')' target='_blank' href='http://windows.microsoft.com/en-US/internet-explorer/downloads/ie' class='l'><span class='bro'>Internet Explorer</span></a></td></tr></tbody></table></div>")
			.css({
			    backgroundColor: '#bfe5ff',
			    'top': '10%',
			    'left': '20%',
